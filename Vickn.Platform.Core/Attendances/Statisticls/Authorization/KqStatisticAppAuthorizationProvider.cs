...
namespace Vickn.Platform.Attendances.Statisticls.Authorization
{
  public  class KqStatisticAppAuthorizationProvider: AuthorizationProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var KqStatisticRecord = entityNameModel.CreateChildPermission(KqStatisticAppPermissions.KqStatistic, L("KqStatistic"));
